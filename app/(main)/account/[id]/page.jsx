...
const AccountsPage= async({params}) => {
  ...
  return (
    <div className="space-y-8 px-5 gap-4 ">
    ...
    <div className="text-right pb-2">
        <div className="text-xl lg:text-2xl font-bold ">${parseFloat(account.balance).toFixed(2)}</div>
        <p className="tex-sm text-muted-foreground">{account._count.transactions} Transactions</p>
    </div>
    </div>
    {/* chart section */}
