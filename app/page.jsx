...
export default function Home() {
  return (
   ...
   <section className="py-20">
    <div className="container mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-12">Everything you need to manange your finances</h2>
  ...
  <CardContent className="pt-4">
    <div className="flex mb-4 items-center">
      <Image src={feature.image} alt={feature.name} width={40} height={40} className="rounded-full"></Image>
      <div className="ml-4">
  ...
  <Link href="/dashboard">
    <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 animate-bounce px-3 text-[15px] pb-2 rounded py-4">
      Start Free Trial
    </Button>
  </Link>
</div>
